...
MOL.instruction = function(id,unit_id,signal,op,oprand1,oprand2,result) {
    ...
    this.op = op;  //op is a string which needs to have an entry in MOLS.ops
...
INS = {};
// add returns 0 if one of them is null (experimental)
INS.add = function(a,b) { if (a === null || b=== null) {return 0;} return a +b;};
MOL.op['add'] = {fp:INS.add, b_result:true};

//only write to the result if oprand1 > oprand2
INS['action>'] = function(a,b) { if (a === null || b=== null) {return false;} return a > b; };
